...
import UIKit
final class CardToDetailTransitionManager2: UIPercentDrivenInteractiveTransition, UIViewControllerTransitioningDelegate {
    ...
    private var originalCardModel: ProjectKarmaModel!
    ...
    weak var cardDetailViewController: DetailedKarmaViewController? {
        didSet {
    ...
    let cardViewModel: ProjectKarmaModel
    weak var fromCell: MainCardStatistics?
    ...
    typealias InitParameters = (fromCardFrame: CGRect, fromCardFrameWithoutTransform: CGRect, viewModel: ProjectKarmaModel, fromCell: MainCardStatistics)
...
extension CardToDetailTransitionManager2: CardDetailInteractivityDelegate {
...
extension CardToDetailTransitionManager2: UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let detailVc = (self.isPresenting ? screens.to : screens.from) as! DetailedKarmaViewController
        ...
        if isPresenting {
            ...
            let animatingCardView = MainCardContent(frame: .zero)
            ...
            (animatingCardView).karmaModel = cardViewModel
...
extension CardToDetailTransitionManager2: UIGestureRecognizerDelegate {
    ...
    func cardDetailDidEnterDismissAnimationState() {
        self.cardDetailViewController?.karmaModel = self.originalCardModel
